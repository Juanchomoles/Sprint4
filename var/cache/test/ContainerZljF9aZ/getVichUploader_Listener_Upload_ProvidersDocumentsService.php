 ...
 */
class getVichUploader_Listener_Upload_ProvidersDocumentsService extends App_KernelTestDebugContainer
{
    /**
     * Gets the private 'vich_uploader.listener.upload.providers_documents' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['vich_uploader.listener.upload.providers_documents'] = new \Vich\UploaderBundle\EventListener\Doctrine\UploadListener('providers_documents', ($container->privates['vich_uploader.adapter.orm'] ??= new \Vich\UploaderBundle\Adapter\ORM\DoctrineORMAdapter()), ($container->privates['vich_uploader.metadata_reader'] ?? self::getVichUploader_MetadataReaderService($container)), ($container->services['vich_uploader.upload_handler'] ?? $container->load('getVichUploader_UploadHandlerService')));
    }
}
