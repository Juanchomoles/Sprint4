...
class App_KernelTestDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\CatalegController' => 'getCatalegControllerService',
            ...
            'App\\Controller\\PrivateCustomerController' => 'getPrivateCustomerControllerService',
            'App\\Controller\\ProfessionalController' => 'getProfessionalControllerService',
            ...
            'Vich\\UploaderBundle\\Naming\\UniqidNamer.providers_documents' => 'getUniqidNamer_ProvidersDocumentsService',
    ...
    {
        return $container->privates['cache.annotations.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('6p11QpeYn6', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    {
        $container->privates['cache.app.recorder_inner'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('Aenwvu9Vxm', 0, ($container->targetDir.''.'/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
    ...
    {
        $container->privates['cache.messenger.restart_workers_signal.recorder_inner'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('mYv8thGQHP', 0, ($container->targetDir.''.'/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
    ...
    {
        return $container->privates['cache.property_info.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('ZANJ2TCHJl', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    {
        return $container->privates['cache.security_expression_language.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('mpQ-4ZkAW-', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    {
        return $container->privates['cache.security_is_granted_attribute_expression_language.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('-037kIQou0', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    {
        return $container->privates['cache.serializer.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('SrZtd4Lkq4', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    {
        return $container->privates['cache.system.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('DW7IIK8Zou', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    {
        return $container->privates['cache.validator.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('biTshGIYsO', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    {
        return $container->privates['cache.validator_expression_language.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('nkpbyhizyQ', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    protected static function getDoctrine_Dbal_DefaultConnection_EventManagerService($container)
    {
        return $container->privates['doctrine.dbal.default_connection.event_manager'] = new \Symfony\Bridge\Doctrine\ContainerAwareEventManager(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            ...
            'vich_uploader.listener.clean.providers_documents' => ['privates', 'vich_uploader.listener.clean.providers_documents', 'getVichUploader_Listener_Clean_ProvidersDocumentsService', true],
            'vich_uploader.listener.remove.providers_documents' => ['privates', 'vich_uploader.listener.remove.providers_documents', 'getVichUploader_Listener_Remove_ProvidersDocumentsService', true],
            'vich_uploader.listener.upload.providers_documents' => ['privates', 'vich_uploader.listener.upload.providers_documents', 'getVichUploader_Listener_Upload_ProvidersDocumentsService', true],
        ], [
            ...
            'vich_uploader.listener.clean.providers_documents' => '?',
            'vich_uploader.listener.remove.providers_documents' => '?',
            'vich_uploader.listener.upload.providers_documents' => '?',
        ]), [[['preUpdate'], 'vich_uploader.listener.clean.providers_documents'], [['postGenerateSchema'], 'doctrine.orm.messenger.doctrine_schema_listener'], [['onSchemaCreateTable'], 'doctrine.orm.messenger.doctrine_schema_listener'], [['postGenerateSchema'], 'doctrine.orm.listeners.doctrine_dbal_cache_adapter_schema_listener'], [['postGenerateSchema'], 'doctrine.orm.listeners.doctrine_token_provider_schema_listener'], [['postGenerateSchema'], 'doctrine.orm.listeners.pdo_session_handler_schema_listener'], [['postGenerateSchema'], 'doctrine.orm.listeners.lock_store_schema_listener'], [['loadClassMetadata'], 'doctrine.orm.default_listeners.attach_entity_listeners'], [['onFlush'], 'turbo.doctrine.event_listener'], [['postFlush'], 'turbo.doctrine.event_listener'], [['preRemove'], 'vich_uploader.listener.remove.providers_documents'], [['postFlush'], 'vich_uploader.listener.remove.providers_documents'], [['prePersist'], 'vich_uploader.listener.upload.providers_documents'], [['preUpdate'], 'vich_uploader.listener.upload.providers_documents']]);
    }
    ...
    protected static function getDoctrine_Orm_ContainerRepositoryFactoryService($container)
    {
        return $container->privates['doctrine.orm.container_repository_factory'] = new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            'App\\Repository\\AdministrativeRepository' => ['privates', 'App\\Repository\\AdministrativeRepository', 'getAdministrativeRepositoryService', true],
            ...
            'App\\Repository\\PrivateCustomerRepository' => ['privates', 'App\\Repository\\PrivateCustomerRepository', 'getPrivateCustomerRepositoryService', true],
            'App\\Repository\\ProfessionalRepository' => ['privates', 'App\\Repository\\ProfessionalRepository', 'getProfessionalRepositoryService', true],
            ...
            'App\\Repository\\AdministrativeRepository' => '?',
            ...
            'App\\Repository\\PrivateCustomerRepository' => '?',
            'App\\Repository\\ProfessionalRepository' => '?',
    ...
    {
        return $container->privates['liip_imagine.filter.configuration'] = new \Liip\ImagineBundle\Imagine\Filter\FilterConfiguration([]);
    }
    ...
    protected static function getLiipImagine_Templating_FilterExtensionService($container)
    {
        ...
        return $container->privates['liip_imagine.templating.filter_extension'] = new \Liip\ImagineBundle\Templating\FilterExtension($a);
    }
    ...
    protected static function getSecurity_ContextListener_0Service($container)
    {
        return $container->privates['security.context_listener.0'] = new \Symfony\Component\Security\Http\Firewall\ContextListener(($container->privates['security.untracked_token_storage'] ??= new \Symfony\Component\Security\Core\Authentication\Token\Storage\TokenStorage()), new RewindableGenerator(function () use ($container) {
            yield 0 => ($container->privates['security.user.provider.concrete.login_provider'] ?? $container->load('getSecurity_User_Provider_Concrete_LoginProviderService'));
    ...
    protected static function getTwigService($container)
    {
        ...
        $instance->addExtension(($container->privates['twig.extension.vue'] ?? self::getTwig_Extension_VueService($container)));
    ...
    /**
     * Gets the private 'twig.extension.vue' shared service.
     *
     * @return \Symfony\UX\Vue\Twig\VueComponentExtension
     */
    protected static function getTwig_Extension_VueService($container)
    {
        $a = ($container->privates['stimulus.helper'] ?? self::getStimulus_HelperService($container));

        if (isset($container->privates['twig.extension.vue'])) {
            return $container->privates['twig.extension.vue'];
        }

        return $container->privates['twig.extension.vue'] = new \Symfony\UX\Vue\Twig\VueComponentExtension($a);
    }
    ...
    protected static function getValidator_ValidatorFactoryService($container)
    {
        return $container->privates['validator.validator_factory'] = new \Symfony\Component\Validator\ContainerConstraintValidatorFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            'App\\Validator\\DniValidator' => ['privates', 'App\\Validator\\DniValidator', 'getDniValidatorService', true],
        ...
        return [
            ...
            'vich_uploader.mappings' => [
                'providers_documents' => [
                    ...
                    'upload_destination' => (\dirname(__DIR__, 4).'/public/providers/documents'),
                    'namer' => [
                        'service' => 'Vich\\UploaderBundle\\Naming\\UniqidNamer.providers_documents',
                        'options' => [
