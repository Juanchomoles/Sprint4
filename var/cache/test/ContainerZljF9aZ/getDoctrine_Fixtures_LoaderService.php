...
class getDoctrine_Fixtures_LoaderService extends App_KernelTestDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->addFixtures([['fixture' => ($container->privates['App\\DataFixtures\\AppFixtures'] ??= new \App\DataFixtures\AppFixtures()), 'groups' => []], ['fixture' => ($container->privates['App\\DataFixtures\\CustomerFixtures'] ?? $container->load('getCustomerFixturesService')), 'groups' => []], ['fixture' => ($container->privates['App\\DataFixtures\\EmployeeFixtures'] ?? $container->load('getEmployeeFixturesService')), 'groups' => []], ['fixture' => ($container->privates['App\\DataFixtures\\ImageFixtures'] ??= new \App\DataFixtures\ImageFixtures()), 'groups' => []], ['fixture' => ($container->privates['App\\DataFixtures\\InvoiceFixtures'] ?? $container->load('getInvoiceFixturesService')), 'groups' => []], ['fixture' => ($container->privates['App\\DataFixtures\\OrderFixtures'] ?? $container->load('getOrderFixturesService')), 'groups' => []], ['fixture' => ($container->privates['App\\DataFixtures\\ProviderFixtures'] ??= new \App\DataFixtures\ProviderFixtures()), 'groups' => []], ['fixture' => ($container->privates['App\\DataFixtures\\VehicleFixtures'] ?? $container->load('getVehicleFixturesService')), 'groups' => []]]);
