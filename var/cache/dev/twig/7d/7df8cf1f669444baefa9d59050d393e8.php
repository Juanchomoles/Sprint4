...
class __TwigTemplate_a6568c96ef5f7435e8851a2a5fe789ce extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    <a href=\"";
        // line 39
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_invoice_edit", ["id" => twig_get_attribute($this->env, $this->source, (isset($context["invoice"]) || array_key_exists("invoice", $context) ? $context["invoice"] : (function () { throw new RuntimeError('Variable "invoice" does not exist.', 39, $this->source); })()), "id", [], "any", false, false, false, 39)]), "html", null, true);
        echo "\">edit</a>
...
";
    ...
    {
        return array (  163 => 41,  158 => 39,  153 => 37,  143 => 30,  136 => 26,  129 => 22,  122 => 18,  112 => 10,  102 => 9,  89 => 6,  79 => 5,  60 => 3,  37 => 1,);
    }
