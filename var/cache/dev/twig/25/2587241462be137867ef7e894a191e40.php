...
class __TwigTemplate_5ef1ede108af9f85b5c52cf181b1f517 extends Template
{
    private $source;
    private $macros = [];
    ...
    <div ";
        // line 8
        echo $this->extensions['Symfony\UX\Vue\Twig\VueComponentExtension']->renderVueComponent("Hello", ["name" => "name"]);
        echo "></div>
";
...
{% block body %}
    ...
    <h1>prova</h1>
    <div {{ vue_component('Hello', { 'name':  'name' }) }}></div>
