...
class __TwigTemplate_3855e34dfa251e124f137e92328dd6b1 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        <section class=\"contingut col-10\">
            ...
            <div id=\"div-table\" ";
        // line 13
        echo $this->extensions['Symfony\UX\Vue\Twig\VueComponentExtension']->renderVueComponent("invoiceList_component", ["invoices" => (isset($context["invoices"]) || array_key_exists("invoices", $context) ? $context["invoices"] : (function () { throw new RuntimeError('Variable "invoices" does not exist.', 13, $this->source); })()), "q" => (isset($context["q"]) || array_key_exists("q", $context) ? $context["q"] : (function () { throw new RuntimeError('Variable "q" does not exist.', 13, $this->source); })())]);
        echo " ></div>
...
";
    ...
    {
        return array (  127 => 16,  121 => 13,  116 => 10,  106 => 9,  94 => 6,  89 => 5,  79 => 4,  60 => 3,  37 => 1,);
    }
...
{% block body %}
        ...
        <section class=\"contingut col-10\">
            <h1>Lista de Facturas</h1>
            <div id=\"div-table\" {{ vue_component('invoiceList_component', { 'invoices': invoices, 'q': q })}} ></div>

    <div class=\"navigation d-flex justify-content-center mt-3\">
        {{ knp_pagination_render(pagination) }}
    </div>
{% endblock %}", "invoice/index.html.twig", "/var/www/html/templates/invoice/index.html.twig");
    }
}
