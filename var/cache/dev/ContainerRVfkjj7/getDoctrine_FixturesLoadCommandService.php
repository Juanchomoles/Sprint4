...
class getDoctrine_FixturesLoadCommandService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $b = ($container->privates['App\\Repository\\PrivateCustomerRepository'] ?? $container->load('getPrivateCustomerRepositoryService'));

        $a->addFixtures([['fixture' => new \App\DataFixtures\AppFixtures(), 'groups' => []], ['fixture' => new \App\DataFixtures\CustomerFixtures(($container->privates['security.user_password_hasher'] ?? $container->load('getSecurity_UserPasswordHasherService'))), 'groups' => []], ['fixture' => new \App\DataFixtures\EmployeeFixtures(), 'groups' => []], ['fixture' => new \App\DataFixtures\ImageFixtures(), 'groups' => []], ['fixture' => new \App\DataFixtures\InvoiceFixtures($b, ($container->privates['App\\Repository\\OrderRepository'] ?? $container->load('getOrderRepositoryService'))), 'groups' => []], ['fixture' => new \App\DataFixtures\OrderFixtures($b, ($container->privates['App\\Repository\\VehicleRepository'] ?? $container->load('getVehicleRepositoryService'))), 'groups' => []], ['fixture' => new \App\DataFixtures\ProviderFixtures(), 'groups' => []], ['fixture' => new \App\DataFixtures\VehicleFixtures(($container->privates['App\\Repository\\ProviderRepository'] ?? $container->load('getProviderRepositoryService'))), 'groups' => []]]);
